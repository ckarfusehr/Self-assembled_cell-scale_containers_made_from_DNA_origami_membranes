...
python /home/ckarfusehr/4_local_software/tacoxDNA/src/oxDNA_PDB.py *.top production_run_mean.trj.dat 53 -H false -u --rmsf-file production_run_deviations.trj.dat.json
